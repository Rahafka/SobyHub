...
const DarkBlueSection: React.FC<unknown> = () => {
    ...
    return (
        <div className="h-screen w-full flex items-center">
            <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 py-10 px-4 bg-soby-gray-blue-gray rounded-3xl ">
                <div className="px-4">
                    <img className="w-56" src={"https://tecdn.b-cdn.net/img/video/Sail-Away.mp4"} />
                </div>
                <div
                    dir={dir}
                ...
                >
                    <div>
                        <h2 className="md:text-4xl text-lg text-soby-light-1 font-bold">
                            {`${t("About")}`}
                        </h2>
                    </div>
                    <div className="md:-mt-6 -mt-3">
                        <h2 className="md:text-7xl text-2xl text-soby-yellow-light font-bold ">
                            {`${t("Soby")}`}
                        </h2>
                    </div>
                    <div className="mt-2  ">
                        <ul className="items-start rtl:flex-end flex-col">
                            <li>
                                <p className="xl:text-xl  text-xs   text-soby-light-1 before:content-['•'] before:mx-1 ">
